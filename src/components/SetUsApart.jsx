    ...
    return <section className={'py-[100px] px-[20px] relative'}>
        <div className={'mx-auto max-w-[1200px] flex justify-center gap-[60px] items-center w-full'}>
            <div className={'max-w-[570px]'}>
                ...
                <p className={'text-[#445d6e] font-open_sans leading-[1.7]'}>The truth is that interview questions and algorithms are difficult. Even more difficult is trying to understand the inner workings of a complex algorithm from a book or from a poorly thought-out video shot on your grandma's camera. Our crisp 1080p videos boast crystal-clear audio and are strategically divided into two parts to give you the most comprehensive explanations to questions. That's over 100  hours of content specifically tailored to make interview questions and algorithms easy.</p>
                <div className={'flex mt-[15px] gap-[20px] items-center'}>
                    <div className={''}>
                        <div className={'flex items-center gap-[15px] mb-[10px]'}>
                            <SolarIcon className={'w-[50px] transition-all hover:scale-[1.2] hover:text-[#626ee3]'} />
                    ...
                    <div className={''}>
                        <div className={'flex items-center gap-[15px] mb-[10px]'}>
                            <KeyboardIcon className={'w-[50px] transition-all hover:scale-[1.2] hover:text-[#626ee3]'} />
