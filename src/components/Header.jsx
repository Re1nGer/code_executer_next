...
const Header = ({ type = 'algo', children }) => {
    ...
    return (
        <HeaderContextProvider>
            ...
            >
                <div className={'mx-auto max-w-[1300px] w-full py-[10px] px-[10px] flex justify-between mb-[60px] md:mb-0'}>
                    <HeaderHamburger />
                    <HeaderLogo />
                    <Navbar />
                    <div className={'max-w-[70px] md:max-w-[150px] lg:max-w-[290px] items-start h-full flex justify-end md:flex-1'}>
