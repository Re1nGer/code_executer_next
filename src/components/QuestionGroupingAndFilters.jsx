...
const QuestionGroupingAndFilters = ({ groupSelected, setGroupSelected }) => {
    ...
    return <section className={"mx-auto text-[#626ee3] flex justify-between max-w-[1600px] w-full mb-[30px]"}>
        ...
        <div className={"flex gap-[3rem] font-bold"}>
            <button className={`transition-colors p-[1rem] bg-transparent border-none rounded-[4px] hover:text-[#02203c] ${groupSelected === 0 ? shadowApplied : ''}`}
