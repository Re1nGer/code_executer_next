...
const TestimonialCard = ({ imgSrc, name, title, story }) => {
    return <div as={'ul'} className={'max-w-[330px] md:w-[369px] lg:w-[325px] ml-[10px] mr-[60px]'}>
        <div className={'rounded-[4px] flex flex-col items-center font-open_sans h-[320px] mt-[30px] mx-[5px] mb-[15px] px-[20px] pb-[20px] pt-[40px] border-t-[4px] border-t-[#626ee3] bg-white shadow-[0_2px_10px_rgba(50,50,93,.1)]'}>
